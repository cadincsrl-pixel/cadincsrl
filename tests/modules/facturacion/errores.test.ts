...
describe('mapRpcError', () => {
  ...
  it('todos los códigos que lanzan las RPC tienen status', () => {
    // Los `raise exception` de 20260924a/c (y 20260924h: la obra es el centro de costo).
    const deLaBase = [
      ...
      'OBRA_REQUERIDA', 'OBRA_INTERNA', 'OBRA_DEPOSITO', 'OBRA_NO_EXISTE', 'CONCEPTO_INVALIDO', 'SIN_RENGLONES',
