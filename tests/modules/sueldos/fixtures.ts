...
function comunes(): ConceptoMotor[] {
  return [
    ...
    concepto({ codigo: 'ley_19032', tipo: 'descuento', calculo: 'porcentaje', base: 'remunerativo', codigo_arca: '810002', unidad: '%', orden: 61, valor: val(3, null) }),
    concepto({ codigo: 'obra_social', tipo: 'descuento', calculo: 'porcentaje', base: 'remunerativo', codigo_arca: '810003', unidad: '%', orden: 62, valor: val(3, null) }),
    ...
    concepto({ codigo: 'contrib_ss', tipo: 'contribucion', calculo: 'porcentaje', base: 'remunerativo', condicion: 'no_rifl', grupo_contribucion: 'seguridad_social', parametro_clave: 'contrib_patronal_pct', unidad: '%', orden: 80, valor: val(18, null, false, 'parametro') }),
    ...
    concepto({ codigo: 'contrib_os', tipo: 'contribucion', calculo: 'porcentaje', base: 'remunerativo', grupo_contribucion: 'obra_social', unidad: '%', orden: 82, valor: val(6, null) }),
