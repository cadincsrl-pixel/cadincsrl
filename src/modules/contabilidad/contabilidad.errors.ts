...
export const STATUS_POR_CODIGO: Readonly<Record<string, number>> = {
  ...
  // Cartera de cheques recibidos (20260930o).
  SIN_CHEQUES: 400, ACCION_INVALIDA: 400, CUENTA_DEPOSITO_INVALIDA: 400, TRANSICION_INVALIDA: 409,
  RANGO_INVALIDO: 400, RANGO_EXCEDE_EJERCICIO: 400, MODO_INVALIDO: 400, NIVEL_INVALIDO: 400,
  ...
  FACTURA_NO_EXISTE: 404, FECHA_INVALIDA: 400, BIEN_SIN_BAJA: 409, CORRIDA_YA_ANULADA: 409,
  ...
  // Abrir el ejercicio siguiente desde Períodos (20260928e).
  EJERCICIO_SIGUIENTE_YA_EXISTE: 409,
  // ── Tanda 5 (20260928l–r) ──
  // Movimientos de fondos y sus adjuntos (tab `tesoreria`, flag `movimientos_fondos`).
  SIN_PERMISO_FONDOS: 403,
  MOVIMIENTO_NO_EXISTE: 404, CONCEPTO_NO_EXISTE: 404, ADJUNTO_NO_EXISTE: 404,
  TIPO_INVALIDO: 400, IMPORTE_INVALIDO: 400, TESORERIA_INVALIDA: 400, TESORERIA_IGUALES: 400,
  TESORERIA_DESTINO_REQUERIDA: 400, DESTINO_NO_CORRESPONDE: 400, CONCEPTO_REQUERIDO: 400, CONCEPTO_NO_CORRESPONDE: 400,
  CONCEPTO_INVALIDO: 400, CONCEPTO_SENTIDO_INVALIDO: 400, COTIZACION_REQUERIDA: 400, IMPORTE_DESTINO_REQUERIDO: 400,
  OBRA_NO_CORRESPONDE: 400, SIN_CAMBIOS: 400,
  MIME_NO_PERMITIDO: 400, TAMANO_INVALIDO: 400, PATH_INVALIDO: 400, ARCHIVO_NO_SUBIDO: 400,
  MOVIMIENTO_ANULADO: 409, MOVIMIENTO_YA_ANULADO: 409, MOVIMIENTO_DE_CONCILIACION: 409,
  CONCEPTO_DUPLICADO: 409, CONCEPTO_SENTIDO_EN_USO: 409, ADJUNTO_DUPLICADO: 409,
  // Asiento mensual de IVA (tab `periodos`, flag `contabilizar`).
  IVA_NO_GENERADO: 404,
  IVA_SIN_MAPEO: 409, IVA_SIN_MOVIMIENTOS: 409, IVA_DIFIERE_DE_LIBROS: 409, IVA_DDJJ_DESACTUALIZADA: 409,
  // Bienes de uso y amortizaciones (tab `bienes`, flag `bienes_uso`).
  SIN_PERMISO_BIENES: 403,
  BIEN_NO_EXISTE: 404, CORRIDA_NO_EXISTE: 404,
  DESCRIPCION_REQUERIDA: 400, VIDA_UTIL_INVALIDA: 400, BU_CUENTA_INVALIDA: 400, BU_RESIDUAL_INVALIDO: 400,
  BU_INICIAL_INVALIDA: 400, BU_SIN_CUENTA_AMORT: 400, BU_SIN_CUENTA_GASTO: 400, HASTA_INVALIDO: 400,
  BIEN_DADO_DE_BAJA: 409, BIEN_CON_AMORTIZACIONES_CERRADAS: 409, BAJA_ANTERIOR_A_AMORTIZADO: 409, AMORTIZADOR_OCUPADO: 409,
