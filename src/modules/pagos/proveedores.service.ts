...
const COLS_PADRON = 'id, razon_social, razon_social_norm, cuit, alias_cbu, cbu, banco, plazo_pago_dias, vencimiento_modo, cierre_dia, forma_pago_habitual, debito_cuenta_id, icl_computa_pago_a_cuenta, concepto_habitual_id, obra_habitual_cod, contacto, telefono, email, obs, activo, baja_motivo, baja_por, baja_at, datos_pago_actualizados_at, datos_pago_actualizados_por, created_at, updated_at, created_by, updated_by, domicilio, provincia, condicion_iva_id, tipo_persona, actividad_principal, padron_consultado_at'
...
function normalizar(dto: Partial<CreateProveedorDto>): Record<string, unknown> {
  ...
  for (const k of ['banco', 'plazo_pago_dias', 'vencimiento_modo', 'forma_pago_habitual', 'debito_cuenta_id', 'icl_computa_pago_a_cuenta', 'contacto', 'telefono', 'email', 'obs'] as const) {
