...
export const STATUS_POR_CODIGO: Readonly<Record<string, number>> = {
  ...
  CONTACTO_EMAIL_DUPLICADO: 409, CONTACTO_DE_OTRO: 400,
  ...
  EXTERNO_NO_EXISTE: 404, RETENCION_NO_EXISTE: 404, RETENCION_SIN_ADJUNTO: 404, ADJUNTO_NO_EXISTE: 404,
  ...
  // Líquido de la CVLP (20260927d): solo 060/061 y nunca más que el total.
  NO_ES_CVLP: 400, LIQUIDO_INVALIDO: 400,
  ...
  CHEQUE_DUPLICADO: 409, RETENCION_DUPLICADA: 409, RETENCION_ADJUNTO_DUPLICADO: 409, ADJUNTO_DUPLICADO: 409, ADJUNTO_INMUTABLE: 409,
  ...
  PRODUCTO_NO_EXISTE: 404, PERIODO_REQUERIDO: 400, PERIODO_INVALIDO: 400,
  PRODUCTO_INACTIVO: 409, PRODUCTO_DUPLICADO: 409, ULTIMO_PRODUCTO_ACTIVO: 409,
  // ── Puntos de venta (20260929d) ──────────────────────────────────────────
  PV_NO_EXISTE: 404, PV_INVALIDO: 400, PTO_VTA_NO_HABILITADO: 409, PV_DUPLICADO: 409,
  PV_NUMERO_NO_EDITABLE: 409, PV_POR_DEFECTO: 409, PV_INACTIVO: 409, PV_NO_VERIFICADO: 409,
  // ── Montos de ARCA con vigencia (20260929e) ───────────────────────────────
  PARAMETRO_NO_EXISTE: 404, PARAMETRO_INVALIDO: 400, PARAMETRO_DUPLICADO: 409,
  PARAMETRO_RETROACTIVO: 409, PARAMETRO_YA_VIGENTE: 409, PARAMETRO_ULTIMO: 409,
  // ── Tipos de retención y configuración de Ventas (20260929f/g) ───────────
  RETENCION_TIPO_NO_EXISTE: 404, RETENCION_TIPO_INVALIDA: 400, CONFIG_INVALIDA: 400, JURISDICCION_NO_EXISTE: 400,
  RETENCION_TIPO_DUPLICADO: 409, RETENCION_TIPO_SISTEMA: 409, IMPUESTO_IVA_RESERVADO: 409, RETENCION_TIPO_POR_DEFECTO: 409,
  PV_NO_EXISTE_EN_ARCA: 422, PV_NO_ES_WEBSERVICE: 422, PV_BLOQUEADO: 422, PV_DADO_DE_BAJA: 422,
  // ── Gastos descontados y carga de liquidaciones (20260930k) ──────────────
  GASTO_INVALIDO: 400, LIQUIDACION_INVALIDA: 400, LIQUIDACION_DUPLICADA: 409,
  GASTO_CONCEPTO_NO_EXISTE: 404, GASTO_CONCEPTO_INVALIDO: 400, GASTO_CONCEPTO_DUPLICADO: 409,
  LIQUIDACION_ILEGIBLE: 422, LIQUIDACION_SIN_CLIENTE: 422,
  // 500
